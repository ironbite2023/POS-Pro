      ...
      <div className="hidden md:block w-1/2 relative">
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          <div className="p-8 text-white text-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="130" height="20" fill="none" className="mx-auto">
              <g clipPath="url(#a)">
            ...
            <Text size="5" className="text-white/90">Restaurant System Management & POS Template for Next.js</Text>
          </div>
        </div>
      </div>
